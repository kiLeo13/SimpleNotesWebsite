...
export function AlreadyAuthWarn({
  setShowWarn
}: AlreadyAuthWarnProps): JSX.Element {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.warnMessageBox}>
        <span>
          ...
          <span className={styles.disclaimer}>
            {t("modals.auth.warn.subtle")}
          </span>
        </span>
        <span className={styles.countdown}>
          <MarkdownDisplay
            content={t("modals.auth.warn.countdown", { time: prettyRemain })}
          />
        </span>
      </div>
      ...
      <div className={styles.warnFooter}>
        <div
          className={clsx(styles.loginButton, styles.button)}
